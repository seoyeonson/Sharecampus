...
<link
	href="${pageContext.request.contextPath}/assets/css/curriculum_regist.css"
	rel="stylesheet">
</head>
<body>
	<div>
			...
			<form class="container">
				...
				<div class="section">
					...
					<div class="input_text_area">
						<h3>커리큘럼명 *</h3>
						<input type="text" name="" placeholder="커리큘럼명" maxlength="100"
							autocomplete="off">
					</div>
					<div class="input_text_area">
						<h3>학과명 *</h3>
						<input type="text" name="" placeholder="학과명" maxlength="100"
							autocomplete="off">
					</div>
					<div>
						<h3>학과 분야 *</h3>
						<div class="group">
							<fieldset>
								<label class="checkbox"><input type="radio"
									name="curri_feild" value="경영·경제">경영·경제</label> <label
									class="checkbox"><input type="radio" name="curri_feild"
									value="컴퓨터·전기·전자">컴퓨터·전기·전자</label> <label class="checkbox"><input
									type="radio" name="curri_feild" value="기계">기계</label> <label
									class="checkbox"><input type="radio" name="curri_feild"
									value="건축·토목">건축·토목</label> <label class="checkbox"><input
									type="radio" name="curri_feild" value="재료·산업·안전">재료·산업·안전</label>
								<label class="checkbox"><input type="radio"
									name="curri_feild" value="농림·수산·축산">농림·수산·축산</label> <label
									class="checkbox"><input type="radio" name="curri_feild"
									value="사회과학">사회과학</label> <label class="checkbox"><input
									type="radio" name="curri_feild" value="간호">간호</label> <label
									class="checkbox"><input type="radio" name="curri_feild"
									value="화공·에너지">화공·에너지</label> <label class="checkbox"><input
									type="radio" name="curri_feild" value="화학·생명·환경">화학·생명·환경</label>
								<label class="checkbox"><input type="radio"
									name="curri_feild" value="수학·물리·천문">수학·물리·천문</label> <label
									class="checkbox"><input type="radio" name="curri_feild"
									value="교육">교육</label> <label class="checkbox"><input
									type="radio" name="curri_feild" value="언어·문학">언어·문학</label> <label
									class="checkbox"><input type="radio" name="curri_feild"
									value="인문학">인문학</label> <label class="checkbox"><input
									type="radio" name="curri_feild" value="미술·응용예술">미술·응용예술</label>
								<label class="checkbox"><input type="radio"
									name="curri_feild" value="생활과학">생활과학</label> <label
									class="checkbox"><input type="radio" name="curri_feild"
									value="음악·연극·영화">음악·연극·영화</label> <label class="checkbox"><input
									type="radio" name="curri_feild" value="체육·무용">체육·무용</label>
							</fieldset>
						</div>
					</div>
					<div class="input_text_area">
						<h3>교과목 구분 *</h3>
						<input type="text" name="" placeholder="교과목 구분" maxlength="100"
							autocomplete="off">
					</div>
					<div>
						<h3>이수학점 *</h3>
					...
					<div class="input_text_area">
						<h3>교수명 *</h3>
						<input type="text" name="" placeholder="교수명" maxlength="100"
							autocomplete="off">
					</div>
				</div>
				<div class="section">
