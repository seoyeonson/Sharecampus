...
<link href="${pageContext.request.contextPath}/assets/css/curriculum.css" rel="stylesheet">
</head>
<body>
    <div>
            ...
            <section class="curriculumSection">
                ...
                <div class="curriculum-list_wrap" style="height: auto !important;">
                    ...
                    <div class="curriculum-title_wrap">
                        ...
                        <a class="curriculum-regist" href="${pageContext.request.contextPath}/app/curriculum/curriculum_regist.jsp">
                            <span>커리큘럼 작성</span>
                        </a>
                    </div>
                    <!-- 과 카테고리 선택 -->
                            ...
                            <li>
                                <div class="curriculum-list_box">
                                    ...
                                    <div class="top-curriculum-info">
                                        ...
                                        <a href="${pageContext.request.contextPath}/app/curriculum/curriculum_detail.jsp" style="padding-bottom: 6px">
