...
<body>
	<div>
		...
		<!-- main start -->
		<main>
	<button type="button" onclick="chkDelete(<%=cnum%>)">삭제하기</button>
	<button type="button" onclick="location.href='/app/curriculum/curriculum.do'">목록으로</button>
	<button type="button" onclick="location.href='/app/curriculum/curriculum_update.do?curri_num=<%=cnum%>'">수정하기</button>
					...
					<div>
						...
						<div>
							<ul class="class_detail_top">
								<li>교과목 구분 <span class="class_division"><%=division%></span></li>
								<li>이수학점<span class="class_credit"><%=credits%></span></li>
								<li>이수학년<span class="class_grade"><%=grade%></span></li>
								<li>교수명<span class="class_prof"><%=professor%></span></li>
							</ul>
						</div>
