...
<div class="modalWrapOpen">
    <div class="loginModal">
        ...
        <button class="loginBtn naver" onclick="location.href='https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=1SE3yDHsMXrLybnglp1f&state=test&redirect_uri=http://localhost:8085/member/naver/login.me'">네이버 아이디로 <span class="changeTxt">가입</span></button>
