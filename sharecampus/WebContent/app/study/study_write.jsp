...
<head>
    ...
    <title>글쓰는 페이지</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/studyWrite.css">
</head>
...
<script src="${pageContext.request.contextPath}/assets/js/studyWrite.js"></script>
