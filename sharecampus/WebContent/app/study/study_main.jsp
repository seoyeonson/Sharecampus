...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/studyMain.css">
    <title>스터디</title>
</head>
                ...
                <div class="picka">
                    ...
                    <div class="favorite">
                        <button class="heart" type="button" onclick="cli()">
                            <img class="img_heart" src="${pageContext.request.contextPath}/assets/images/heart-empty.png" width="18px" height="18px">
                        </button>
                    </div>
                    <br>
                    <div class="purpose">
                    ...
                    <br>
                    <div class="num">
                        <img class="smallheart" src="${pageContext.request.contextPath}/assets/images/heart-empty.png" width="10px" height="10px">
                ...
                <div class="pickb ">
                    ...
                    <div class="favorite">
                        <button class="heart" type="button">
                            <img class="img_heart" src="${pageContext.request.contextPath}/assets/images/heart-empty.png" width="18px" height="18px"></button>
                    </div>
                    <br>
                    <div class="purpose">
                        기획&PO스터디
...
<script src="${pageContext.request.contextPath}/assets/js/studyMain.js"></script>
