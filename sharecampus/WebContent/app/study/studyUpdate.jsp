...
<body>
	...
	<div id="maindiv">
			...
			<form id="container" action="${pageContext.request.contextPath}/study/listDuOk.su" method="post" name="updateForm">
				...
				<div class="manager" data-managerfor="first">
					...
					<p class="input medium">
						<input type="text" name="studyContact" placeholder="연락 수단 (오픈 카톡..)"
							autocomplete="off" value="${study.getStudyContact()}">
					</p>
			...
			<div class="section">
				...
				<p class="input">
					<input type="text" name="studyTitle" placeholder="제목 *" maxlength="40"
						autocomplete="off" value="${study.getStudyTitle()}">
				</p>
				...
				<p class="input medium">
					<input type="number" min="0" name="studyPeople" placeholder="인원수"
						maxlength="40" autocomplete="off" value="${study.getStudyPeople()}">
				</p>
			</div>
			<div class="section">
				<h2>상세 내용</h2>
				<p class="input">
					<textarea name="studyIntro"><c:out value="${study.getStudyIntro()}"/></textarea>
				</p>
			</div>
