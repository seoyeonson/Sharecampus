                    ...
                    <div class="sMypageAccount">
                        ...
                        <div class="sMypageAccountCont">
                            ...
                            <div class="sMypageAccountItem _phoneActionPanel">
                                ...
                                <div class="content">
                                    ...
                                    <button type="button" class="infoIcon -help" id="" style="cursor: pointer;">
                                        <img src="${pageContext.request.contextPath}/assets/images/mypage/search.png" style="  background-color: transparent;">
                                    </button>
                                    <!--휴대폰 번호 수집하는 경고 문구 출력 -->
                                </div>
                                   <!-- 휴대폰 번호 선택  끝-->
                            ...
                            <div class="sMypageAccountItem _emailActionPanel">
                                <label class="label" for="email_view630">이메일</label>
                                <div class="content">
                                    <div class="uInput -simpleLine" style="width: 100%;">
                                        <!-- 이메일 주소 입력 -->
                    ...
                    <div class="sMypageConnectOrganization">
                        ...
                        <div class="sMypageConnectDocumnet">
                           ...
                           <div class="btn" style="display: flex; justify-content: flex-end;">
                            ...
                            <!-- 해당 파일을 DB로 보냄-->
                            <button type="submit" class="uButton -sizeS -confirm3 _btnConnectDocument">요청</button>
                        </div>
                    </div>
                </div>
        </main>
...
>>>>>>> bd1af3e982681abf4efb3aaf40767a6d6708fede
</div>
</section>
</section>
	<jsp:include
