...
<body>
	...
	<section>
		...
		<div class="projectView projectAllGridView">
			...
			<c:choose>
				<c:when test ="${not empty activityAll and fn:length(activityAll) > 0 }">
						...
						<div class="top">
							<div class="badgeWrap">
								...
								<div class="badge blue">
									<h2 class ="dept" value='<c:out value="${activity.getActivDept()}"/>'>(분야)</h2>
								</div>
							</div>
				...
				<div class="projectGridWrap"
					...
					<div class="projectBottomInfo">
						<div class="txtWrap studyTxtWrap">
							<h3 class="category" value='<c:out value= "${activity.getActivArea()}"/>'>(지역)</h3>
							<h2 class="tit" value='<c:out value= "${activity.getActivTitle}"/>'>(대외활동 제목)</h2>
