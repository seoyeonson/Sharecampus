...
public class SelectCommController implements Execute {

	@Override
	public Result execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServerException {
		System.out.println("SelectCommController");
...
//			한 페이지에서 나오는 페이지 버튼의 개수
			...
			int total = memberDAO.getCommTotal(memberNum);
			...
			req.setAttribute("commAll", memberDAO.selectComm(pageMap));
			...
			result.setPath("/app/member/mypage_community.jsp");
		} catch (Exception e) {
