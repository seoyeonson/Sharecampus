...
public class NaverLoginController implements Execute {

	@Override
	public Result execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServerException {
		System.out.println("NaverLoginController 들어옴");
		...
		final String AUTH_HOST = "https://nid.naver.com";
	    final String tokenRequestUrl = AUTH_HOST + "/oauth2.0/token";
	    ...
	    String REDIRECT_URI = "http://localhost:8085/member/naver/login.me";
	    ...
	    try {
	    	...
	    	final String params = String.format("grant_type=authorization_code&client_id=%s&client_secret=%s&redirect_uri=%s&code=%s",
...
//	    	conn.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
	    	...
	    	access_token = data.substring(data.indexOf("access_token") + 15, data.indexOf("refresh_token") - 3);
    	...
    	result.setPath("/member/naver/naverLoginMember.me");
		return result;
	}
}
