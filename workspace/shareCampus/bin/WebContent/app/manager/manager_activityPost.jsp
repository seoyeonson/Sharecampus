...
<link rel="stylesheet" href="manager_style.css">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/app/assets/css/manager_button.css">
...
<body>
    <div class="wrapper">
        <div class="sidebar" id="menu">
            ...
            <ul>
                <li>
                    <a href="#" class="menu"><img src="${pageContext.request.contextPath}/app/assets/images/globe.png">사이트 바로가기</a>
                </li>
                <li>
                    <a href="manager_managerHome.html" class="menu"><img src="${pageContext.request.contextPath}/app/assets/images/home.png">관리자 홈</a>
                </li>
                <li>
                    <a><img src="${pageContext.request.contextPath}/app/assets/images/user.png">회원 관리<img src="${pageContext.request.contextPath}/app/assets/images/menu-burger.png" style="float: right; height:20px;"></a>
                    <ul>
                ...
                <li>
                        <a><img src="${pageContext.request.contextPath}/app/assets/images/apps.png">콘텐츠 관리<img src="${pageContext.request.contextPath}/app/assets/images/menu-burger.png" style="float: right; height:20px;"></a>
                            <ul>
                ...
                <li>
                        <a><img src="${pageContext.request.contextPath}/app/assets/images/chart.png">통계<img src="${pageContext.request.contextPath}/app/assets/images/menu-burger.png" style="float: right; height:20px;"></a>
                    <ul>
                ...
                <li>
                        <a><img src="${pageContext.request.contextPath}/app/assets/images/settings.png">환경 설정<img src="${pageContext.request.contextPath}/app/assets/images/menu-burger.png" style="float: right; height:20px;"></a>
                    <ul>
