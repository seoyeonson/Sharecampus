...
<link rel="stylesheet" href="${pageContext.request.contextPath}/app/assets/css/activity_new.css">
<script type="text/javascript" src="${pageContext.request.contextPath}/app/assets/js/activity_new.js"></script>
<body>
	...
	<form id="container">
		<div class="section">
			<h1>대외활동 게시 요청</h1>
			<p class="description">
				대외활동 게시는 <strong>무료로 진행</strong>되며,<br>담당자의 검토 및 승인 절차를 걸쳐 48시간
				이내 게시됩니다.
			</p>
		</div>
		<div class="section">
			...
			<div class="manager" data-managerfor="first">
				...
				<p class="agreement">게시물 관리, 게시 처리 안내, 유료 광고 게재 안내 등을 위해 담당자
					이메일, 이름, 연락처, 소속을 수집합니다. 수집한 개인정보는 2년 이후 즉시 파기됩니다. (게시 요청 또는 게시물 관리
					계정 접속 기준)</p>
				<label class="agreement"><input type="checkbox" name="agree">위
					내용에 동의합니다.</label>
			</div>
		...
		<div class="section">
			...
			<p class="input medium">
				<input type="text" name="attach_filename" placeholder="본문 *"
					...
					id="my-input" name="attach" class="attachfile"> <input
					type="button" name="attach_button" value="파일 선택"
