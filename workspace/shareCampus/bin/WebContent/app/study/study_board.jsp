...
<head>
	...
	<title>스토리보드</title>
	<link rel="stylesheet" href="${pageContext.request.contextPath}/app/assets/css/studyBoard.css">
</head>
		...
		<div id="afthd">
			<div id="box">
				...
				<div class="profile">
					<div class="profPic">
						<img
							src="${pageContext.request.contextPath}/app/assets/images/men.jpg"
...
<script src="${pageContext.request.contextPath}/app/assets/js/studyBoard.js"></script>
