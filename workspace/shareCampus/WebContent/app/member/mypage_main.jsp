...
<head>
	<meta charset="UTF-8">
	<link rel="stylesheet" href="${pageContext.request.contextPath}/app/assets/css/mypage.css">
			...
			<section class="sMypage">
							...
							<div class="sMypageAccountItem _phoneActionPanel">
								...
								<div class="content">
									...
									<button type="button" class="infoIcon -help" id=""
										...
										<img src="${pageContext.request.contextPath}/app/assets/images/search.png"
					...
					<div class="sMypageConnect">
						...
						<div class="sMypageConnectCont">
							<div class="sMypageConnectItem">
								...
								<img class="id_icon"
									src="${pageContext.request.contextPath}/app/assets/images/icon_login_naver.png">
							...
							<div class="sMypageConnectItem">
								...
								<img class="id_icon"
									src="${pageContext.request.contextPath}/app/assets/images/icon_login_kakao.png">
								<div class="content off">아이디로 연결할 수 있습니다.</div>
								<div class="btn">
									<button type="submit"
										class="uButton -sizeS -confirm3 _btnConnectFirstSite">
				...
				<div class="sMypageConnectOrganization">
					...
					<div class="sMypageConnectDocumnet">
						...
						<img class="id_icon" src=${pageContext.request.contextPath}/app/assets/images/engine-warning.png">
...
<script src="${pageContext.request.contextPath}/app/assets/js/mypage.js"></script>
</html>