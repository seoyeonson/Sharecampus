...
<body>
  <div class="wrapper">
    ...
    <div class="contents">
        <h3>회원 뱃지 관리</h3>
        <input type="button" value="자세히 보기" class="confirm_btn" id="badge_btn" onclick="member_alert()">
          <table class="confirm">
            <thead>
            <tr>
                <th>
                    <input type="checkbox" name="selectallbadge" id="badges_chk" onclick='selectAllBadge(this)'>
                </th>
                <th>뱃지</th><th>회원명</th><th>획득일</th><th>사용 여부</th>
            </tr>
            </thead>
            <tbody>
              <tr>
                <td>
                    <input type="checkbox" name="badge_btn" id="badge_chk1" onclick='checkSelectAllBadge()'>
                </td>
                <td>00뱃지</td>
                <td>000</td>
                <td>0000-00-00</td>
              ...
              <tr>
                <td>
                    <input type="checkbox" name="badge_btn" id="badge_chk2" onclick='checkSelectAllBadge()'>
                </td>
                <td></td>
                <td></td>
                <td></td>
              ...
              <tr>
                <td>
                    <input type="checkbox" name="badge_btn" id="badge_chk3" onclick='checkSelectAllBadge()'>
                </td>
                <td></td>
                <td></td>
                <td></td>
              ...
              <tr>
                <td>
                    <input type="checkbox" name="badge_btn" id="badge_chk4" onclick='checkSelectAllBadge()'>
                </td>
                <td></td>
                <td></td>
                <td></td>
              ...
              <tr>
                <td>
                    <input type="checkbox" name="badge_btn" id="badge_chk5" onclick='checkSelectAllBadge()'>
                </td>
                <td></td>
                <td></td>
                <td></td>
          ...
          <div class="badgeLevel">
            <span class="title">뱃지 지급 기준<hr></span>
            <span class="in">
                글 0개 이상 <br>
                댓글 0개 이상 <br>
                방문횟수 0회 이상 <br>
