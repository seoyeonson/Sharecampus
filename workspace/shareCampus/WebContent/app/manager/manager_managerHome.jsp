...
<head>
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-246180959-1"></script>
<script>
...
<div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li>
                        <a><img src="manager_images/settings.png">환경 설정<img src="images/menu-burger.png" style="float: right; height:20px;"></a>
                    <ul>
    ...
    <div class="contents">
        <h3>관리자 모드</h3>
            <div class="card card1"><p>방문자 현황
            </p></div>
            <div class="card card2"><p>일자별 요약</p></div>
            <div class="card card3"><p>신규 회원</p></div>
            <div class="card card4"><p>최근 신고된 글</p></div>
            <div class="card card5"><p>뱃지 획득 현황</p></div>
            <div class="card card6"><p>문의글</p></div>
    </div>
