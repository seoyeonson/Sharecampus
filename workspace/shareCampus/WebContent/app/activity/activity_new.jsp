...
<link rel="stylesheet" href="activity_new.css">
...
<body>
    ...
    <body>
        ...
        <form id="container">
            <div class="section">
                <h1>대외활동 게시 요청</h1>
                <p class="description">대외활동 게시는 <strong>무료로 진행</strong>되며,<br>담당자의 검토 및 승인 절차를 걸쳐 48시간 이내 게시됩니다.</p>
            </div>
            <div class="section">
                <h2>담당자 정보</h2>
                <div class="manager" data-managerfor="first">
                    <p class="input medium">
                        <input type="email" name="manager_email" placeholder="이메일" maxlength="100" autocomplete="off">
                    </p>
                    <p class="input medium"><input type="text" name="manager_name" placeholder="이름" maxlength="10"
                            autocomplete="off"></p>
                    <p class="input medium"><input type="number" name="manager_phone" placeholder="연락처 (- 없이 숫자만)"
                            autocomplete="off"></p>
                    <p class="input medium"><input type="text" name="manager_company" placeholder="소속" maxlength="40"
                            autocomplete="off"></p>
                    <p class="agreement">게시물 관리, 게시 처리 안내, 유료 광고 게재 안내 등을 위해 담당자 이메일, 이름, 연락처, 소속을 수집합니다. 수집한 개인정보는 2년
                        이후 즉시 파기됩니다.
                        (게시 요청 또는 게시물 관리 계정 접속 기준)</p>
                    <label class="agreement"><input type="checkbox" name="agree">위 내용에 동의합니다.</label>
                </div>
                <div class="manager" data-managerfor="again" style="display: none;">
                    <p class="input medium"><input type="email" name="manager_again_email" placeholder="이메일"
                            maxlength="100"></p>
                    <p class="input medium"><input type="password" name="manager_again_password" placeholder="비밀번호"></p>
                    <p class="button medium"><input type="button" name="manager_again_button" value="이메일 및 비밀번호 확인"></p>
                </div>
            </div>
            <div class="section">
                <h2>활동 개요</h2>
                ...
                <p class="input"><input type="text" name="website" placeholder="웹사이트 (http:// 포함)" autocomplete="off">
                </p>
                <h3>지역 *</h3>
                <div class="group area">
                    <label class="checkbox"><input type="radio" name="area" value="KR01">서울특별시</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR02">경기도</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR03">부산광역시</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR04">인천광역시</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR05">대구광역시</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR06">경상남도</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR07">경상북도</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR08">대전광역시</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR09">충청남도</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR10">충청북도</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR11">전라남도</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR12">전라북도</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR13">광주광역시</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR14">강원도</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR15">울산광역시</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR16">제주특별자치도</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR17">세종특별자치시</label>
                    <label class="checkbox"><input type="radio" name="area" value="KR00">기타</label>
                </div>
                <h3>분야 *</h3>
                ...
                <h3>접수 기간 *</h3>
                <p class="input small"><input type="date" name="start_date" autocomplete="off"
                        class="date"><span>부터</span></p>
                <p class="input small"><input type="date" name="end_date" autocomplete="off"
                        class="date"><span>까지</span></p>
                <h3>활동기간 *</h3>
                <div class="group">
                ...
                <p class="input medium"><input type="number" min="0" name="num_people" placeholder="인원수" maxlength="40"
                    autocomplete="off"></p>
                <h3>기관 정보</h3>
                <p class="input medium"><input type="text" name="company" placeholder="주최 기관명" maxlength="40"
                        autocomplete="off"></p>
            </div>
            <div class="section">
                <h2>상세 내용</h2>
            ...
            <div class="section">
                ...
                <p class="input medium">
                    <input type="text" name="attach_filename" placeholder="본문 *" class="attachtext" readonly>
                    <input type="file" id="my-input" name="attach" class="attachfile">
                    <input type="button" name="attach_button" value="파일 선택" class="attachbutton" onclick="onClickUpload();">
                </p>
                <p class="input medium thumbnail">
                    <input type="text" name="attach_filename" placeholder="썸네일" class="attachtext" readonly>
                    <input type="file" id="my-input" name="attach" class="attachfile">
                    <input type="button" name="attach_button" value="파일 선택" class="attachbutton" onclick="onClickUpload();">
                </p>
            </div>
            ...
            <div class="section">
                <h2>유의사항</h2>
                <ul class="description">
                    <li>공모전 및 대외활동 정보만 게시할 수 있습니다. 동아리, 스터디, 구인 등의 정보는 다른 커뮤니티를 이용해주세요.</li>
                    <li>대외활동의 경우 봉사활동, 기자단, 서포터즈, 홍보대사, 마케터, 강연에 해당하는 대외활동만 게시할 수 있습니다.</li>
                    ...
                    <ul>
                        ...
                        <li>기관/정치인/정당/종교/시민단체와 직간접적으로 연관되거나, 관련한 온오프라인 활동을 하는 공모전·대외활동</li>
            ...
            <div class="submit"><input type="submit" value="게시 요청하기"></div>
        </form>
