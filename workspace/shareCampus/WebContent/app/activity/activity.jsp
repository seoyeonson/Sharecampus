...
<script src="${pageContext.request.contextPath}/app/assets/js/activity.js"></script>
<body>
			...
			<div class="searchOption">
				...
				<div class="activityNew">
					<a href="activity_new.html"> <img
						src="${pageContext.request.contextPath}/app/assets/images/activity_new_button.PNG" alt="공고 등록 버튼">
					</a>
				</div>
			</div>
